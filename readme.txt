To run:
	Linux:
		Make sure glew, SDL2, SDL2_ttf, and supporting OpenGL packages are installed
	Windows:
...
To compile:
	Linux:
		...
		along with pkg-config for sdl2, SDL2_ttf, glew, and glew
	Windows:
		Make sure SDL2, SDL2_ttf, and glew include and lib files are copied into MinGW's folders
